...
const A2 = () => {
    ...
    const handleSubjectClick = (subject) => {
        ...
        if (subject === 'Toán') {
            history.push('/course/grade11/a2/toan');
        } else if (subject === 'Ngữ văn') {
            history.push('/course/grade11/a2/van');
        } else if (subject === 'Ngoại ngữ') {
            history.push('/course/grade11/a2/anh');
        } else if (subject === 'Khoa học tự nhiên') {
            history.push('/course/grade11/a2/khoahoctunhien');
        } else if (subject === 'Khoa học xã hội') {
            history.push('/course/grade10/a2/khoahocxahoi');
        }
    };
