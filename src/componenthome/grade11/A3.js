...
const A3 = () => {
    ...
    const handleSubjectClick = (subject) => {
        ...
        if (subject === 'Toán') {
            history.push('/course/grade11/a3/toan');
        } else if (subject === 'Ngữ văn') {
            history.push('/course/grade11/a3/van');
        } else if (subject === 'Ngoại ngữ') {
            history.push('/course/grade11/a3/anh');
        } else if (subject === 'Khoa học tự nhiên') {
            history.push('/course/grade11/a3/khoahoctunhien');
        } else if (subject === 'Khoa học xã hội') {
            history.push('/course/grade11/a3/khoahocxahoi');
        }
    };
    return (
