...
const A1 = () => {
    ...
    const handleSubjectClick = (subject) => {
        ...
        if (subject === 'Toán') {
            history.push('/course/grade12/a1/toan');
        } else if (subject === 'Ngữ văn') {
            history.push('/course/grade12/a1/van');
        } else if (subject === 'Ngoại ngữ') {
            history.push('/course/grade12/a1/anh');
        } else if (subject === 'Khoa học tự nhiên') {
            history.push('/course/grade12/a1/khoahoctunhien');
        } else if (subject === 'Khoa học xã hội') {
            history.push('/course/grade12/a1/khoahocxahoi');
        }
    };
